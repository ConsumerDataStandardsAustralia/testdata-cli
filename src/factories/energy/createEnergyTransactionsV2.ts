...
const factoryId: string = "create-energy-transactions-v2";

export class CreateEnergyTransactionV2 extends Factory {
    ...
    public get briefDescription(): string {
        return "This factory will create some EnergyBillingTransactionsV2";
    }
    public get detailedDescription(): string {
        let st =`
This factory will create some EnergyBillingTransactionsV2.
...
`
    ...
    public generateEnergyTransaction(account: EnergyAccountWrapper, servicePoints: EnergyServicePointWrapper[]): EnergyBillingTransactionV2 | undefined 
    { 
    ...
    private generateBillingDemand(): EnergyBillingDemandTransactionV2 {
        let ret: EnergyBillingDemandTransactionV2 = {
            endDate: Helper.randomDateTimeInTheFuture(),
            startDate: Helper.randomDateTimeInThePast(),
