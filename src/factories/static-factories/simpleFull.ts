...
`;
  ...
  public generateEnergyTransaction(account: EnergyAccountWrapper): any | undefined {
    return {
      accountId: account.account.accountId,
  ...
  public generateEnergyTransactions(account: EnergyAccountWrapper): any[] | undefined {
    let count = Helper.isPositiveInteger(this.options.options?.count) ? (this.options.options?.count as number) : 1;
